...
def setup_pk_inference():
    ...
    output = model.variables.get(qname="PKCompartment.C1")
    ...
    bt = BiomarkerType.objects.create(
        name="fake data",
        dataset=dataset,
        stored_unit=Unit.objects.get(symbol="mg/L"),
        display_unit=Unit.objects.get(symbol="mg/L"),
