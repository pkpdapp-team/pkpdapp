...
def TestVariableModel(TestCase):
    def test_variable_creation(self):
        ...
        self.assertTrue('variable must belong to a model' in str(context.exception))
        ...
        self.assertTrue('log scale must have a lower bound greater than zero' in str(context.exception))