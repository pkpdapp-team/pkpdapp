...
from pkpdapp.models import (
    InferenceResults, Inference, Dataset, PharmacodynamicModel
)


class TestInferenceResults(TestCase):
    def test_inference_results_creation(self):
        ...
        ir = InferenceResults.objects.create(
            inference=i,
            inference_type=it,
            time_elapsed=te,
            operations_nb=on
        ...
        self.assertTrue(isinstance(ir, InferenceResults))