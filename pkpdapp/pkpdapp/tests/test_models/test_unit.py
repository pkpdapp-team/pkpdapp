...
class TestUnitModel(TestCase):
    ...
    def check_compatible_unit(self, unit_symbol, compatible_units, compound=None):
        ...
        compat_symbols = [u.symbol for u in unit.get_compatible_units(compound=compound)]
    ...
    def test_compatible_units(self):
        ...
        self.check_compatible_unit('ng/mL', ['ng/mL', 'µg/mL', 'mg/L', 'ng/L', 'g/L', 'g/dL', 'pg/mL'])
    ...
    def test_compatible_units_mols_per_kg(self):
        ...
        self.check_compatible_unit('nmol/kg', ['nmol/kg', 'pmol/kg', 'µmol/kg', 'mg/kg', 'pg/kg', 'µg/kg', 'ng/kg', ''], compound=self.compound)
        self.check_compatible_unit('mg/kg', ['mg/kg', 'pg/kg', 'µg/kg', 'ng/kg', ''])
        self.check_compatible_unit('mg/kg', ['nmol/kg', 'pmol/kg', 'µmol/kg', 'mg/kg', 'pg/kg', 'µg/kg', 'ng/kg', 'g/mol', 'g/nmol', ''], compound=self.compound)