    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='name of the biomarker for a particular dataset', max_length=100)),
                ('description', models.TextField(help_text='description of the biomarker for a particular dataset')),
            ],
        ),
        migrations.CreateModel(
            name='BiomarkerType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biomarkers', models.ManyToManyField(related_name='dataset', through='pkpdapp.BiomarkerMap', to='pkpdapp.BiomarkerType')),
            ],
        ),
        migrations.CreateModel(
            name='PkpdModel',
        ...
        migrations.AddField(
            model_name='biomarkermap',
            name='biomarker_type',
            field=models.ForeignKey(help_text='biomarker type, for example "concentration in mg"', on_delete=django.db.models.deletion.CASCADE, to='pkpdapp.BiomarkerType'),
        ),
        migrations.AddField(
            model_name='biomarkermap',
            name='dataset',
            field=models.ForeignKey(help_text='dataset containing this biomarker measurement', on_delete=django.db.models.deletion.CASCADE, to='pkpdapp.Dataset'),
        ),
        migrations.CreateModel(
            name='Biomarker',
            fields=[
                ...
                ('biomarker_type', models.ForeignKey(help_text='biomarker type, for example "concentration in mg"', on_delete=django.db.models.deletion.CASCADE, to='pkpdapp.BiomarkerMap')),
