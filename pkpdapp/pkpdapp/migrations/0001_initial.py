# Generated by Django 3.0.7 on 2021-01-11 15:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biomarkers', models.ManyToManyField(through='pkpdapp.BiomarkerMap', to='pkpdapp.BiomarkerType')),
            ],
        ),
        migrations.CreateModel(
            name='PkpdModel',
        ...
        migrations.AddField(
            ...
            name='biomarker_type',
            field=models.ForeignKey(help_text='biomarker type, for example "concentration in mg"', on_delete=django.db.models.deletion.PROTECT, to='pkpdapp.BiomarkerType'),
        ),
        migrations.AddField(
            model_name='biomarkermap',
            name='dataset',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biomarker_type', models.ForeignKey(help_text='biomarker type, for example "concentration in mg"', on_delete=django.db.models.deletion.PROTECT, to='pkpdapp.BiomarkerMap')),
