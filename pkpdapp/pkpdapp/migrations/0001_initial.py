...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='loglikelihood',
            constraint=models.CheckConstraint(check=models.Q(('form', 'F'), ('value__isnull', False)), name='loglikelihood: fixed log_likelihood must have a value'),
        ),
        migrations.AddConstraint(
            model_name='loglikelihood',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('form', 'F'), ('form', 'S'), ('form', 'M'), _connector='OR'), ('biomarker_type__isnull', True), ('subject_group__isnull', True)), name='loglikelihood: deterministic log_likelihoods cannot have data'),
        ),
        migrations.AddField(
            model_name='dose',
            name='protocol',
