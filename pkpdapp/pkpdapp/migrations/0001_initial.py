    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('read_only', models.BooleanField(default=False, help_text='true if object has been stored')),
                ('datetime', models.DateTimeField(blank=True, help_text='datetime the object was stored.', null=True)),
                ('dosed_pk_model', models.ForeignKey(help_text='PK part of model', on_delete=django.db.models.deletion.CASCADE, related_name='pkpd_models', to='pkpdapp.dosedpharmacokineticmodel')),
                ('pd_model', models.ForeignKey(help_text='PD part of model', on_delete=django.db.models.deletion.CASCADE, related_name='pkpd_models', to='pkpdapp.pharmacodynamicmodel')),
