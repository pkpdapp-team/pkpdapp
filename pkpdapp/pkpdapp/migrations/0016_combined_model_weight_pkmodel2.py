...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.BooleanField(default=False, help_text='whether the pk model has extravascular model'),
        ),
        migrations.AddField(
            model_name='combinedmodel',
            name='pk_model2',
        ...
        migrations.AlterField(
            ...
            name='type',
            field=models.CharField(choices=[('AUC', 'area under curve'), ('RO', 'receptor occupancy'), ('FUP', 'faction unbound plasma'), ('BPR', 'blood plasma ratio'), ('TLG', 'dosing lag time')], help_text='type of derived variable', max_length=3),
        ),
    ]
