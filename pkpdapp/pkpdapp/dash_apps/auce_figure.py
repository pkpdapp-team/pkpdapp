...
def update_figure(time_selection, y_selection, class1_selection, concentration_selection, class2_selection,
    ...
    for index_concentration, concentration_selected in enumerate(concentration):
        ...
        concentration_data = data.loc[data[concentration_selection]
        ...
        for index_class2, class2_selected in enumerate(class2):
            ...
            class2_data = concentration_data.loc[concentration_data[class2_selection]
                                                 == class2_selected]
            ...
            if class3_plot_selection:
                ...
                for index_class3, class3_selected in enumerate(class3):
                    class3_data = class2_data.loc[class2_data[class3_selection]
                                                  == class3_selected]
                ...
                fig.add_trace(go.Scatter(
                    ...
                    name="%s : %s, %s : %s" % (
                        concentration_selection, concentration_selected, class2_selection, class2_selected),
                    showlegend=True,
                    visible=True,
                    hovertemplate=(
                        "<b>Measurement </b><br>" +
...
def calculate_model_values(data, time_selection, y_selection, class1_selected, concentration_selected, class2_selected,
    ...
    if class3_selected:
        modeling_values.series = '''Y_type : {}, Concentration : {}, Drug : {}, ID : {}'''.format(
            class1_selected, concentration_selected, class2_selected, class3_selected)
    else:
        modeling_values.series = '''Y_type : {}, Concentration : {}, Drug : {}'''.format(
            class1_selected, concentration_selected, class2_selected)
...
def compute_auce_vs_concentration(time_selection, auce_conc_fit_type, auce_y_axis_type, auce_x_axis_type, y_selection, class1_selection, concentration_selection, class2_selection,
    ...
    class2 = [
        class2_plot_selection] if class2_plot_selection else data[class2_selection].unique()
    ...
    for index_class2, class2_selected in enumerate(class2):
        ...
        for index_concentration, concentration_selected in enumerate(concentrations):
            ...
            concentration_data = class2_data.loc[class2_data[concentration_selection]
                                                 == concentration_selected]
            ...
            children=[
                dcc.Tab(
                    ...
                    children=html.Div(className='control-tab', children=[
                        ...
                        html.Div([html.Span("Time :", style={'font-weight': 'bold'}),
                                  ...
                                  html.Span("Dose group selection :",
                                            style={'color': 'grey'}),
                                  ...
                                  html.Span("Classifier 1 selection : ",
                                  ...
                                  html.Span("Classifier 2 selection :",
                                            style={'color': 'grey'}),
                                  ...
                                  html.Span("Classifier 3 selection :",
                                            style={'color': 'grey'}),
                ...
                dcc.Tab(
                    ...
                    children=html.Div(className='control-tab', children=[
                        ...
                        html.Button(id='auce-button', n_clicks=0,
                                    children='Compute AUC parameters'),
                        html.Button(id='auce-concentration-button', n_clicks=0,
                                    children='Compute AUCE vs concentration'),
                ...
                dcc.Tab(
                    ...
                    value='explore-about',
                    children=html.Div(className='control-tab', children=[
                        html.H4(className='explore-about',
                                children='How to plot you data'),
                        html.P(
                            """
