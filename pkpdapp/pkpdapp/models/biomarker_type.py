...
class BiomarkerType(models.Model):
    ...
    name = models.CharField(max_length=100, help_text="name of the biomarker type")
    ...
    description = models.TextField(
        help_text="short description of the biomarker type", blank=True, null=True
    )
    ...
    axis = models.BooleanField(
        default=False,
        help_text=("True/False if biomarker type displayed on LHS/RHS axis"),
    )
    ...
    def data(self, first_time_only=False):
        ...
        if is_continuous:
            conversion_factor = self.stored_unit.convert_to(self.display_unit)
