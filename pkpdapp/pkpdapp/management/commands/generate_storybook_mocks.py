...
export const project: ProjectRead = {self._to_typescript(project)};

export const compound: CompoundRead = {self._to_typescript(compound)};

export const users: UserRead[] = {self._to_typescript(user_list)};
...
export const combinedModels: CombinedModelRead[] = {self._to_typescript(combined_models)};

export const pkModels: PharmacokineticRead[] = {self._to_typescript(pk_models)};

export const pdModels: PharmacodynamicRead[] = {self._to_typescript(pd_models)};

export const tags: TagRead[] = {self._to_typescript(tags)};
...
export const protocols: ProtocolRead[] = {self._to_typescript(protocols)};

export const dose: DoseRead = {self._to_typescript(dose)};
...
export const units: UnitRead[] = {self._to_typescript(units)};
...
export const variables: VariableRead[] = {self._to_typescript(variables)};
