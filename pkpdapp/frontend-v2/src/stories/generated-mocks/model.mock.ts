...
export const combinedModels: CombinedModelRead[] = [
  {
    id: 3,
    mappings: [
      {
...
export const pkModels: PharmacokineticRead[] = [
  {
    id: 1,
    read_only: false,
    datetime: null,
...
export const pdModels: PharmacodynamicRead[] = [
  {
    id: 1,
    components: [
      {
