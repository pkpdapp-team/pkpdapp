...
export const combinedModels = [
  {
    ...
    diffsl: {
      ...
      code: "/*\nThis file was generated by Myokit.\n\nauthor: Michael Gertz\nname: 1-compartmental model\n\n*/\n\n/* Input parameters */\nin_i {\n  PDCompartmentE0 = 100.0, /* PDCompartment.E0 [1] */\n  PDCompartmentImax = 0.8, /* PDCompartment.Imax [1] */\n}\n\n/* Constants: Extravascular */\nExtravascularKa { 1.0 } /* Extravascular.ka [S/F (0.0002777777777777778)] */\n\n/* Constants: PKCompartment */\nPKCompartmentCL { 1.0 } /* PKCompartment.CL [m^3/s (2.777777777777775e-07)] */\nPKCompartmentCLada { 0.0 } /* PKCompartment.CLada [m^3/s (2.777777777777775e-07)] */\nPKCompartmentF { 1.0 } /* PKCompartment.F [1] */\nPKCompartmentV1 { 1.0 } /* PKCompartment.V1 [L] */\nPKCompartmentTada { 240.0 } /* PKCompartment.tada [s (3600)] */\n\n/* Constants: PDCompartment */\nPDCompartmentC50 { 100000.0 } /* PDCompartment.C50 [mM (1e-09)] */\nPDCompartmentHC { 1.0 } /* PDCompartment.HC [1] */\n\n/* Initial conditions */\nu_i {\n  PKCompartmentA1 = 0.0, /* PKCompartment.A1 [mol (1e-12)] */\n  ExtravascularAa = 0.0, /* Extravascular.Aa [mol (1e-12)] */\n}\n\n/* Variables: Extravascular */\nExtravascularRateAbs { ExtravascularKa * ExtravascularAa } /* Extravascular.RateAbs [kat (2.777777777777775e-16)] */\n\n/* Variables: PKCompartment */\nPKCompartmentRateAbs { ExtravascularRateAbs } /* PKCompartment.RateAbs [kat (2.777777777777775e-16)] */\nPKCompartmentC1 { PKCompartmentA1 / PKCompartmentV1 } /* PKCompartment.C1 [mM (1e-09)] */\nPKCompartmentCLimm { ((1 - heaviside(t / 3.60000000000000373e+06 - PKCompartmentTada)) * 0.0 + (1 - (1 - heaviside(t / 3.60000000000000373e+06 - PKCompartmentTada))) * PKCompartmentCLada) } /* PKCompartment.CLimm [m^3/s (2.777777777777775e-07)] */\n\n/* Variables: PDCompartment */\nPDCompartmentCDrug { 1.0 * PKCompartmentC1 } /* PDCompartment.C_Drug [mM (1e-09)] */\nPDCompartmentPDO { pow(PDCompartmentCDrug, PDCompartmentHC) / (pow(PDCompartmentCDrug, PDCompartmentHC) + pow(PDCompartmentC50, PDCompartmentHC)) } /* PDCompartment.PDO [1] */\nPDCompartmentE { (heaviside(PDCompartmentE0 - 0.0) * heaviside(0.0 - PDCompartmentE0) * -PDCompartmentImax * PDCompartmentPDO + (1 - heaviside(PDCompartmentE0 - 0.0) * heaviside(0.0 - PDCompartmentE0)) * PDCompartmentE0 * (1.0 - PDCompartmentImax * PDCompartmentPDO)) } /* PDCompartment.E [1] */\nPDCompartmentINH { PDCompartmentImax * PDCompartmentPDO } /* PDCompartment.INH [1] */\n\n/* Solve */\nF_i {\n  (PKCompartmentRateAbs * PKCompartmentF - PKCompartmentCL * PKCompartmentC1 - PKCompartmentCLimm * PKCompartmentC1) / 3.60000000000000373e+06,\n  -ExtravascularRateAbs / 3.60000000000000373e+06,\n}\n\n/* Output */\nout_i {\n  PDCompartmentCDrug,\n  ExtravascularRateAbs,\n  PKCompartmentC1,\n  PKCompartmentCLimm,\n  t,\n  PDCompartmentE,\n  PDCompartmentINH,\n  PDCompartmentPDO,\n}\n"
    },
...
export const pkModels = [
  ...
  },
  {
    ...
    read_only: false,
    datetime: null,
    name: "2-compartmental Michaelis-Menten TMDD model (linear and saturable CL)",
    description: "2-compartmental Michaelis-Menten TMDD model (linear and saturable CL)",
    mmt: "[[model]]\nname: 2-compartmental Michaelis-Menten TMDD model (linear and saturable CL)\nauthor: Michael Gertz\n\n\n# Initial values:\nPKCompartment.A1 = 0\nPKCompartment.A2 = 0\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PKCompartment]\n\nF = 1 in [dimensionless]\n  desc: Fraction absorbed / bioavailability \n	\nV1 = 1 in [L]\n  desc: Volume of the central compartment	\n	\nV2 = 1 in [L]\n  desc: Volume of the first peripheral compartment	\n	\nCL = 1 in [L/h]\n  desc: Linear clearance from central compartment \n	\nQ1 = 1 in [L/h]\n  desc: Intercompartmental clearance between central and first peripheral compartment\n\nVmax = 100 in [pmol/h]\n  desc: Maximum rate of saturable clearance from central compartment  \n\nKm = 1000 in [pmol/L]\n  desc: Michaelis-Menten constant   \n  \nCLada = 0 in [L/h]\n  desc: ADA-mediated clearance \n\ntada = 240 in [h]\n  desc: Time at which ADA-mediated clearance first occurs\n\nCLimm = if(environment.t < tada , \n	0 , \n	CLada) in [L/h]\n\n	\nC1 = A1/V1 in [pmol/L]\n  desc: Concentration of drug in the central compartment\n	\nC2 = A2/V2 in [pmol/L]\n  desc: Concentration of drug in the first peripheral compartment\n  \nRateAbs = 0 in [pmol/h] \n  desc: Absorption rate\n  \n\ndot(A1) = RateAbs*F - Q1*(C1 - C2) - CL*C1 - Vmax/(Km + C1)*C1 - CLimm*C1 in [pmol]\n  desc: Amount of drug in the central compartment \n	\ndot(A2) = Q1*(C1 - C2) - CLimm*C2*V2/V1 in [pmol]\n  desc: Amount of drug in the first peripheral compartment",
    time_max: 30.0,
    is_library_model: true,
    model_type: "PK",
    tags: [
  ...
  },
  {
    ...
    read_only: false,
    datetime: null,
    name: "2-compartmental Michaelis-Menten TMDD model (saturable CL only)",
    description: "2-compartmental Michaelis-Menten TMDD model (saturable CL only)",
    mmt: "[[model]]\nname: 2-compartmental Michaelis-Menten TMDD model (saturable CL only)\nauthor: Michael Gertz\n\n\n# Initial values:\nPKCompartment.A1 = 0\nPKCompartment.A2 = 0\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PKCompartment]\n\nF = 1 in [dimensionless]\n  desc: Fraction absorbed / bioavailability \n	\nV1 = 1 in [L]\n  desc: Volume of the central compartment	\n	\nV2 = 1 in [L]\n  desc: Volume of the first peripheral compartment\n	\nQ1 = 1 in [L/h]\n  desc: Intercompartmental clearance between central and first peripheral compartment\n\nVmax = 100 in [pmol/h]\n  desc: Maximum rate of saturable clearance from central compartment  \n\nKm = 1000 in [pmol/L]\n  desc: Michaelis-Menten constant   \n  \nCLada = 0 in [L/h]\n  desc: ADA-mediated clearance \n\ntada = 240 in [h]\n  desc: Time at which ADA-mediated clearance first occurs\n\nCLimm = if(environment.t < tada , \n	0 , \n	CLada) in [L/h]\n\n	\nC1 = A1/V1 in [pmol/L]\n  desc: Concentration of drug in the central compartment\n	\nC2 = A2/V2 in [pmol/L]\n  desc: Concentration of drug in the first peripheral compartment\n  \nRateAbs = 0 in [pmol/h] \n  desc: Absorption rate\n  \n\ndot(A1) = RateAbs*F - Q1*(C1 - C2) - Vmax/(Km + C1)*C1 - CLimm*C1 in [pmol]\n  desc: Amount of drug in the central compartment \n	\ndot(A2) = Q1*(C1 - C2) - CLimm*C2*V2/V1 in [pmol]\n  desc: Amount of drug in the first peripheral compartment",
    time_max: 30.0,
    is_library_model: true,
    model_type: "PK",
    tags: [
  ...
  },
  {
    ...
    read_only: false,
    datetime: null,
    name: "1-compartmental Michaelis-Menten TMDD model (linear and saturable CL)",
    description: "1-compartmental Michaelis-Menten TMDD model (linear and saturable CL)",
    mmt: "[[model]]\nname: 1-compartmental Michaelis-Menten TMDD model (linear and saturable CL)\nauthor: Michael Gertz\n\n\n# Initial values:\nPKCompartment.A1 = 0\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PKCompartment]\n\nF = 1 in [dimensionless]\n  desc: Fraction absorbed / bioavailability \n	\nV1 = 1 in [L]\n  desc: Volume of the central compartment	\n	\nCL = 1 in [L/h]\n  desc: Linear clearance from central compartment\n\nVmax = 100 in [pmol/h]\n  desc: Maximum rate of saturable clearance from central compartment  \n\nKm = 1000 in [pmol/L]\n  desc: Michaelis-Menten constant   \n  \nCLada = 0 in [L/h]\n  desc: ADA-mediated clearance \n\ntada = 240 in [h]\n  desc: Time at which ADA-mediated clearance first occurs\n\nCLimm = if(environment.t < tada , \n	0 , \n	CLada) in [L/h]\n\n	\nC1 = A1/V1 in [pmol/L]\n  desc: Concentration of drug in the central compartment\n  \nRateAbs = 0 in [pmol/h] \n  desc: Absorption rate\n  \n\ndot(A1) = RateAbs*F - CL*C1 - Vmax/(Km + C1)*C1 - CLimm*C1 in [pmol]\n  desc: Amount of drug in the central compartment",
    time_max: 30.0,
    is_library_model: true,
    model_type: "PK",
    tags: [
  ...
  },
  {
    ...
    read_only: false,
    datetime: null,
    name: "1-compartmental Michaelis-Menten TMDD model (saturable CL only)",
    description: "1-compartmental Michaelis-Menten TMDD model (saturable CL only)",
    mmt: "[[model]]\nname: 1-compartmental Michaelis-Menten TMDD model (saturable CL only)\nauthor: Michael Gertz\n\n\n# Initial values:\nPKCompartment.A1 = 0\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PKCompartment]\n\nF = 1 in [dimensionless]\n  desc: Fraction absorbed / bioavailability \n	\nV1 = 1 in [L]\n  desc: Volume of the central compartment\n\nVmax = 100 in [pmol/h]\n  desc: Maximum rate of saturable clearance from central compartment  \n\nKm = 1000 in [pmol/L]\n  desc: Michaelis-Menten constant    \n  \nCLada = 0 in [L/h]\n  desc: ADA-mediated clearance \n\ntada = 240 in [h]\n  desc: Time at which ADA-mediated clearance first occurs\n\nCLimm = if(environment.t < tada , \n	0 , \n	CLada) in [L/h]\n\n	\nC1 = A1/V1 in [pmol/L]\n  desc: Concentration of drug in the central compartment\n  \nRateAbs = 0 in [pmol/h] \n  desc: Absorption rate\n  \n\ndot(A1) = RateAbs*F - Vmax/(Km + C1)*C1 - CLimm*C1 in [pmol]\n  desc: Amount of drug in the central compartment",
    time_max: 30.0,
    is_library_model: true,
    model_type: "PK",
    tags: [
...
export const pdModels = [
  ...
  },
  {
    ...
    components: [
      {
        ...
        outputs: [],
        equations: [
          "<math xmlns=\"http://www.w3.org/1998/Math/MathML\"><mrow><mfrac><mi>dPDCompartment.E</mi><mi>dt</mi></mfrac><mo>=</mo><mrow><mrow><mrow><mrow><mi>PDCompartment.kdegP</mi><mo>*</mo><mi>PDCompartment.P</mi></mrow><mo>*</mo><mi>PDCompartment.FE</mi></mrow><mo>*</mo><mi>PDCompartment.STM</mi></mrow><mo>-</mo><mrow><mi>PDCompartment.kdegE</mi><mo>*</mo><mi>PDCompartment.E</mi></mrow></mrow></mrow></math>",
          "<math xmlns=\"http://www.w3.org/1998/Math/MathML\"><mrow><mfrac><mi>dPDCompartment.P</mi><mi>dt</mi></mfrac><mo>=</mo><mrow><mrow><mi>PDCompartment.kdegP</mi><mo>*</mo><mi>PDCompartment.P0</mi></mrow><mo>-</mo><mrow><mrow><mi>PDCompartment.kdegP</mi><mo>*</mo><mi>PDCompartment.P</mi></mrow><mo>*</mo><mfenced><mrow><mrow><mi>PDCompartment.FE</mi><mo>*</mo><mi>PDCompartment.STM</mi></mrow><mo>+</mo><mfenced><mrow><mn>1.0</mn><mo>-</mo><mi>PDCompartment.FE</mi></mrow></mfenced></mrow></mfenced></mrow></mrow></mrow></math>"
        ]
      },
      {
        name: "environment",
    ...
    variables: [],
    mmt: "[[model]]\nname: Indirect effect model with precursor (stimulation of precursor elimination)\nauthor: Michael Gertz, Soledad Castano  \n\n\n# Initial values:\nPDCompartment.P = PDCompartment.E0*PDCompartment.kdegE/(PDCompartment.kdegP*PDCompartment.FE)\nPDCompartment.E = PDCompartment.E0\n\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PDCompartment]\n\nkdegP = 0.1 in [1/h]\n	desc: Degradation rate constant of precursor\n	\nFE = 1 in [dimensionless]\n	desc: Fraction of precursor that is converted to effect\n\nkdegE = 2 in [1/h]	\n	desc: Degradation rate constant of the effect\n\nE0 = 100 in [dimensionless]\n	desc: Baseline of the PD effect\n	\nEmax = 5 in [dimensionless]\n	desc: Maximal fold change from baseline (value range: 1 (no effect) to infinity)\n	\nC50 = 100000 in [pmol/L]\n	desc: Concentration that produces half-maximal effects\n\nHC = 1 in [dimensionless]\n	desc: Hill coefficient\n	\nC_Drug = 1 in [pmol/L]\n	desc: Drug concentration causing the PD effect\n\nP0 = E0*kdegE/(kdegP*FE) in [dimensionless]\n	desc: Baseline of the precursor\n\nPDO = C_Drug^HC/(C_Drug^HC+C50^HC) in [dimensionless]\n	desc: Pharmacodynamic occupancy\n	\nSTM = 1+(Emax-1)*PDO in [dimensionless]\n	desc: PD Stimulus\n\ndot(P) = kdegP*P0 - kdegP*P*(FE*STM + (1-FE)) in [dimensionless]\n	desc: Precursor\n	\ndot(E) = kdegP*P*FE*STM - kdegE*E in [dimensionless]\n	desc: PD effect",
    read_only: false,
    datetime: null,
    name: "Indirect effect model with precursor (stimulation of precursor elimination)",
  ...
  },
  {
    ...
    components: [
      {
        ...
        outputs: [],
        equations: [
          "<math xmlns=\"http://www.w3.org/1998/Math/MathML\"><mrow><mfrac><mi>dPDCompartment.E</mi><mi>dt</mi></mfrac><mo>=</mo><mrow><mi>PDCompartment.kdegE</mi><mo>*</mo><mfenced><mrow><mi>PDCompartment.E0</mi><mo>-</mo><mrow><mi>PDCompartment.E</mi><mo>*</mo><mi>PDCompartment.STM</mi></mrow></mrow></mfenced></mrow></mrow></math>"
        ]
      },
      {
        name: "environment",
    ...
    variables: [],
    mmt: "[[model]]\nname: Indirect effect model (stimulation of elimination)\nauthor: Michael Gertz, Soledad Castano  \n\n\n# Initial values:\nPDCompartment.E = PDCompartment.E0\n\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PDCompartment]\n\nkdegE = 0.05 in [1/h]\n	desc: Degradation rate constant of the effect\n\nE0 = 100 in [dimensionless]\n	desc: Baseline of the PD effect\n	\nEmax = 5 in [dimensionless]\n	desc: Maximal fold change from baseline (value range: 1 (no effect) to infinity)\n	\nC50 = 100000 in [pmol/L]\n	desc: Concentration that produces half-maximal effects\n\nHC = 1 in [dimensionless]\n	desc: Hill coefficient\n	\nC_Drug = 1 in [pmol/L]\n  desc: Drug concentration causing the PD effect\n\nPDO = C_Drug^HC/(C_Drug^HC+C50^HC) in [dimensionless]\n	desc: Pharmacodynamic occupancy\n	\nSTM = 1+(Emax-1)*PDO in [dimensionless]\n	desc: PD Stimulus	\n\ndot(E) = kdegE*(E0-E*STM) in [dimensionless]\n	desc: PD effect",
    read_only: false,
    datetime: null,
    name: "Indirect effect model (stimulation of elimination)",
    description: "Indirect effect model (stimulation of elimination)",
  ...
  },
  {
    ...
    components: [
      {
        ...
        outputs: [],
        equations: [
          "<math xmlns=\"http://www.w3.org/1998/Math/MathML\"><mrow><mfrac><mi>dPDCompartment.E</mi><mi>dt</mi></mfrac><mo>=</mo><mrow><mi>PDCompartment.kdegE</mi><mo>*</mo><mfenced><mrow><mrow><mi>PDCompartment.E0</mi><mo>*</mo><mi>PDCompartment.STM</mi></mrow><mo>-</mo><mi>PDCompartment.E</mi></mrow></mfenced></mrow></mrow></math>"
        ]
      },
      {
        name: "environment",
    ...
    variables: [],
    mmt: "[[model]]\nname: Indirect effect model (stimulation of production)\nauthor: Michael Gertz, Soledad Castano  \n\n\n# Initial values:\nPDCompartment.E = PDCompartment.E0\n\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PDCompartment]\n\nkdegE = 0.05 in [1/h]\n	desc: Degradation rate constant of the effect\n\nE0 = 100 in [dimensionless]\n	desc: Baseline of the PD effect\n	\nEmax = 5 in [dimensionless]\n	desc: Maximal fold change from baseline (value range: 1 (no effect) to infinity)\n	\nC50 = 100000 in [pmol/L]\n	desc: Concentration that produces half-maximal effects\n\nHC = 1 in [dimensionless]\n	desc: Hill coefficient\n	\nC_Drug = 1 in [pmol/L]\n  desc: Drug concentration causing the PD effect\n \nPDO = C_Drug^HC/(C_Drug^HC+C50^HC) in [dimensionless]\n	desc: Pharmacodynamic occupancy\n	\nSTM = 1+(Emax-1)*PDO in [dimensionless]\n	desc: PD Stimulus	\n\ndot(E) = kdegE*(E0*STM-E) in [dimensionless]\n	desc: PD effect",
    read_only: false,
    datetime: null,
    name: "Indirect effect model (stimulation of production)",
    description: "Indirect effect model (stimulation of production)",
  ...
  },
  {
    ...
    variables: [],
    mmt: "[[model]]\nname: Tumor growth model (exponential)\nauthor: Michael Gertz, Soledad Castano\n\n\n# Initial values:\nPDCompartment.TS = PDCompartment.TS0\n\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PDCompartment]\n\nTS0 = 0.1 in [dimensionless]\n	desc: Initial tumor volume/ size\n\nkge = 0.005 in [1/h]\n	desc: Exponential growth rate constant\n\ngamma = 1 in [dimensionless]\n	desc: 0 < gamma <= 1; gamma = 1 leads to exponential growth, gamma = 2/3, tumor radius expands linearly with time\n\nGrowth = if(TS > 1e12,\n    0,\n    kge*TS^gamma) in [1/h]\n	desc: Tumor growth rate\n\ndot(TS) = Growth in [dimensionless]\n	desc: Tumor volume/ size",
    read_only: false,
    datetime: null,
    name: "Tumor growth model (exponential)",
  ...
  },
  {
    ...
    variables: [],
    mmt: "[[model]]\nname: Tumor growth model (Gompertz)\nauthor: Michael Gertz, Soledad Castano\n\n\n# Initial values:\nPDCompartment.TS = PDCompartment.TS0\n\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PDCompartment]\n\nTS0 = 0.1 in [dimensionless]\n	desc: Initial tumor volume/ size\n\nTSmax = 10 in [dimensionless]\n	desc: Maximal tumor volume/ size\n\nbeta = 0.002 in [1/h]\n	desc: Growth rate constant\n\nGrowth = if(TS > 1e12,\n    0,\n    TS*beta*log(TSmax/TS)) in [1/h]\n	desc: Tumor growth rate\n\ndot(TS) = Growth in [dimensionless]\n	desc: Tumor volume/ size",
    read_only: false,
    datetime: null,
    name: "Tumor growth model (Gompertz)",
  ...
  },
  {
    ...
    variables: [],
    mmt: "[[model]]\nname: Tumor growth model (Simeoni-logistic)\nauthor: Michael Gertz, Soledad Castano\n\n\n# Initial values:\nPDCompartment.TS = PDCompartment.TS0\n\n\n[environment]\nt = 0 in [h] bind time\n \n\n[PDCompartment]\n\nTS0 = 0.1 in [dimensionless]\n	desc: Initial tumor volume/ size\n\nTSmax = 10 in [dimensionless]\n	desc: Maximal tumor volume/ size\n\nkgl = 0.01 in [1/h]\n	desc: Linear growth rate\n\nkge = 0.005 in [1/h]\n	desc: Exponential growth rate constant\n\npsi = 20 in [dimensionless]\n	desc: Set to a value of 20 for a rapid switch between exponential and linear phase\n\nGrowth = if(TS > 1e12,\n    0,\n    kge*TS*(1-TS/TSmax)/((1+(kge/kgl*TS)^psi)^(1/psi))) in [1/h]\n	desc: Tumor growth rate\n\ndot(TS) = Growth in [dimensionless]\n	desc: Tumor volume/ size",
    read_only: false,
    datetime: null,
    name: "Tumor growth model (Simeoni-logistic)",
  ...
  },
  {
    ...
    variables: [],
    mmt: "[[model]]\nname: Tumor growth model (Simeoni)\nauthor: Michael Gertz, Soledad Castano\n\n\n# Initial values:\nPDCompartment.TS = PDCompartment.TS0\n\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PDCompartment]\n\nTS0 = 0.1 in [dimensionless]\n	desc: Initial tumor volume/ size\n\nkgl = 0.01 in [1/h]\n	desc: Linear growth rate\n\nkge = 0.005 in [1/h]\n	desc: Exponential growth rate constant\n\npsi = 20 in [dimensionless]\n	desc: Set to a value of 20 for a rapid switch between exponential and linear phase\n\nGrowth = if(TS > 1e12,\n    0,\n    kge*TS/((1 + (kge/kgl*TS)^psi)^(1/psi))) in [1/h]\n	desc: Tumor growth rate\n\ndot(TS) = Growth in [dimensionless]\n	desc: Tumor volume/ size",
    read_only: false,
    datetime: null,
    name: "Tumor growth model (Simeoni)",
  ...
  },
  {
    ...
    variables: [],
    mmt: "[[model]]\nname: TGI cell distribution model (conc prop kill)\nauthor: Michael Gertz, Soledad Castano\n\n\n# Initial values:\nPDCompartment.TS = PDCompartment.TS0\nPDCompartment.TS1 = 0\nPDCompartment.TS2 = 0\nPDCompartment.TS3 = 0\n\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PDCompartment]\n\nTS0 = 0.1 in [dimensionless]\n	desc: Initial tumor volume/ size\n	\nkKill = 0.00000001 in [1/h*L/pmol]\n	desc: Kill rate constant\n	\nMtt = 72 in [h]\n	desc: Average life span \n	\ntau = Mtt/3 in [h]\n  desc: Delay in treatment effect\n  \nC_Drug = 1 in [pmol/L]	\n	desc: Drug concentration causing tumor killing\n\nKill = kKill * C_Drug in [1/h]\n	desc: Tumor kill rate constant\n\ndot(TS) = -Kill*TS in [dimensionless]\n	desc: Tumor volume (drug-unaffeced)\n	\ndot(TS1) = Kill*TS -TS1/tau in [dimensionless]\n	desc: Transit compartment 1 (delay due to cell distribution) \n\ndot(TS2) = (TS1-TS2)/tau in [dimensionless]\n	desc: Transit compartment 2 (delay due to cell distribution)\n\ndot(TS3) = (TS2-TS3)/tau in [dimensionless]\n	desc: Transit compartment 3 (delay due to cell distribution)\n	\nTSTotal = TS1 + TS2 + TS3 + TS in [dimensionless]\n	desc: Total tumor volume/ size",
    read_only: false,
    datetime: null,
    name: "TGI cell distribution model (conc prop kill)",
  ...
  },
  {
    ...
    variables: [],
    mmt: "[[model]]\nname: TGI cell distribution model (conc exp kill)\nauthor: Michael Gertz, Soledad Castano\n\n\n# Initial values:\nPDCompartment.TS = PDCompartment.TS0\nPDCompartment.TS1 = 0\nPDCompartment.TS2 = 0\nPDCompartment.TS3 = 0\n\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PDCompartment]\n\nTS0 = 0.1 in [dimensionless]\n	desc: Initial tumor volume/ size\n	\nkmax = 0.015 in [1/h]\n	desc: Maximal kill rate constant\n	\nC50 = 1000000 in [pmol/L]\n	desc: Concentration of half-maximal effect\n	\nMtt = 72 in [h]\n	desc: Average life span \n	\ntau = Mtt/3 in [h]\n  desc: Delay in treatment effect\n \nC_Drug = 1 in [pmol/L]\n	desc: Drug concentration causing tumor killing	\n\nKill = kmax * (1 - exp(-log(2)/C50 * C_Drug)) in [1/h]\n	desc: Tumor kill rate constant\n\ndot(TS) = -Kill*TS in [dimensionless]\n	desc: Tumor volume/ size (drug-unaffeced)\n	\ndot(TS1) = Kill*TS-TS1/tau in [dimensionless]\n	desc: Transit compartment 1 (delay due to cell distribution) \n\ndot(TS2) = (TS1-TS2)/tau in [dimensionless]\n	desc: Transit compartment 2 (delay due to cell distribution)\n\ndot(TS3) = (TS2-TS3)/tau in [dimensionless]\n	desc: Transit compartment 3 (delay due to cell distribution)\n	\nTSTotal = TS1 + TS2 + TS3 + TS in [dimensionless]\n	desc: Total tumor volume/ size",
    read_only: false,
    datetime: null,
    name: "TGI cell distribution model (conc exp kill)",
    description: "TGI cell distribution model (conc exp kill)",
    time_max: 30.0,
    is_library_model: true,
    model_type: "TGI",
    project: null,
  ...
  },
  {
    ...
    variables: [],
    mmt: "[[model]]\nname: TGI signal distribution model (conc exp kill)\nauthor: Michael Gertz, Soledad Castano\n\n\n# Initial values:\nPDCompartment.TS = PDCompartment.TS0\nPDCompartment.K1 = 0\nPDCompartment.K2 = 0\nPDCompartment.K3 = 0\n\n\n[environment]\nt = 0 in [h] bind time\n\n\n[PDCompartment]\n	\nTS0 = 0.1 in [dimensionless]\n	desc: Initial tumor volume/ size\n	\nkmax = 0.015 in [1/h]\n	desc: Maximal kill rate constant\n	\nC50 = 1000000 in [pmol/L]\n	desc: Concentration of half-maximal effect\n\nMtt = 72 in [h]\n	desc: Average duration of transduction\n	\ntau = Mtt/3 in [h]\n  desc: Delay in treatment effect\n\nC_Drug = 1 in [pmol/L]\n	desc: Drug concentration causing tumor killing\n\nKill = kmax * (1 - exp(-log(2)/C50 * C_Drug)) in [1/h]\n	desc: Tumor kill rate constant\n\ndot(TS) = -K3*TS in [dimensionless]\n	desc: Tumor size/ size \n	\ndot(K1) = (Kill-K1)/tau in [1/h]\n	desc: Transit compartment 1 (delay of killing due to signal distribution) \n\ndot(K2) = (K1-K2)/tau in [1/h]\n	desc: Transit compartment 2 (delay of killing due to signal distribution)\n\ndot(K3) = (K2-K3)/tau in [1/h]\n	desc: Transit compartment 3 (delay of killing due to signal distribution)",
    read_only: false,
    datetime: null,
    name: "TGI signal distribution model (conc exp kill)",
    description: "TGI signal distribution model (conc exp kill)",
    time_max: 30.0,
    is_library_model: true,
    model_type: "TGI",
    project: null,
